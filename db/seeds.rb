...
Project.create([ 
  { 
    ...
    integration: nil,
    overview: "<p>Conway's Game of Life is a cellular automaton simulator in which cells live, die or reproduce based on their number of neighbors. It leads to hypnotizing graphical flourishes as these 'cells' spread all over the screen.</p>
